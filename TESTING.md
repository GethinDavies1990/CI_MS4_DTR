- [Testing](#testing)
  * [Unit testing information](#unit-testing-information)
    ...
    + [Unit testing information for the Events App](#unit-testing-information-for-the-events-app)
  * [Responsiveness Testing](#responsiveness-testing)
    + [Homepage](#homepage)
    + [Feature 1 Navigation & Homepage](#feature-1-navigation---homepage)
    ...
    + [Feature 2 Footer](#feature-2-footer)
      - [Description feature 2](#description-feature-2-1)
      - [User Stories Steps 1](#user-stories-steps-1-1)
      - [User Story Testing Results 1](#user-story-testing-results-1-1)
    + [Feature 3 Register](#feature-3-register)
      - [Description feature 3](#description-feature-3)
      - [User Stories Steps 1](#user-stories-steps-1-2)
      - [User Story Testing Results 1](#user-story-testing-results-1-2)
    + [Feature 4 Login](#feature-4-login)
      - [Description feature 4](#description-feature-4)
      - [User Stories Steps 1](#user-stories-steps-1-3)
      - [User Story Testing Results 1](#user-story-testing-results-1-3)
    + [Feature 5 Login](#feature-5-login)
      - [Description feature 5](#description-feature-5)
      - [User Stories Steps 1](#user-stories-steps-1-4)
      - [User Story Testing Results 1](#user-story-testing-results-1-4)
    + [Feature 6 Profile](#feature-6-profile)
      - [Description feature 6](#description-feature-6)
      - [User Stories Steps 1](#user-stories-steps-1-5)
      - [User Story Testing Results 1](#user-story-testing-results-1-5)
    + [Feature 7 Bag And checkout](#feature-7-bag-and-checkout)
      - [Description feature 7](#description-feature-7)
      - [User Stories Steps 1](#user-stories-steps-1-6)
      - [User Story Testing Results 1](#user-story-testing-results-1-6)
    + [Feature 8 Admin](#feature-8-admin)
      - [User Story 8.7](#user-story-87)
      - [User Story Steps 8.7](#user-story-steps-87)
      - [User Story Testing Results 8.7](#user-story-testing-results-87)
      - [User Story 8.8](#user-story-88)
      - [User Story Steps 8.8](#user-story-steps-88)
      - [User Story Testing Results 8.8](#user-story-testing-results-88)
      - [User Story 8.9](#user-story-89)
      - [User Story Steps 8.9](#user-story-steps-89)
      - [User Story Testing Results 8.9](#user-story-testing-results-89)
      - [User Story 8.10](#user-story-810)
      - [User Story Steps 8.10](#user-story-steps-810)
      - [User Story Testing Results 8.10](#user-story-testing-results-810)
      - [User Story 8.11](#user-story-811)
      - [User Story Steps 8.11](#user-story-steps-811)
      - [User Story Testing Results 8.11](#user-story-testing-results-811)
...
- [Code Validators and Website Analysis](#code-validators-and-website-analysis)
  ...
  * [JSHint](#jshint)
  * [Python Validation - Code Institute](#python-validation---code-institute)
